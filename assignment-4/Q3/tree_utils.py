...
class LeafNode(object):
    ...
    def predict(self, x_TF):
        ...
        # --- START OF SOLUTION (TASK A) ---
        
        # For regression, the optimal prediction at a leaf
        # is the mean of the y values that reached this leaf.
        y_mean = np.mean(self.y_N)
        
        # Return an array of this mean value, one for each input sample.
        yhat_T = y_mean * np.ones(T, dtype=np.float64)
        return yhat_T
